...
-- Trigger otomatis membuat school + profile setelah pendaftaran.
...
-- Helper untuk RLS: user hanya melihat data sekolah miliknya.
...
-- View ringkasan poin per siswa untuk kebutuhan report/API lanjutan.
create or replace view student_point_summary as
select
...
-- RLS untuk view mengikuti tabel sumber saat query dilakukan lewat authenticated role.
